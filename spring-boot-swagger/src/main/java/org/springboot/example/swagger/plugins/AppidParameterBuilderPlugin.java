...
//import springfox.documentation.config.Parameter;
//import springfox.documentation.spi.DocumentationType;
//import springfox.documentation.spi.schema.contexts.ModelContext;
//import springfox.documentation.spi.config.ParameterBuilderPlugin;
//import springfox.documentation.spi.config.contexts.ParameterContext;
//
...
////                            .description("按属性排序如: sort=id,message&sort=code,asc")
////                            .build()
////              ,
////                    context.parameterBuilder()
