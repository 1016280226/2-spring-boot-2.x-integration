package org.springboot.example.utils;
...
//            System.out.println("响应内容: " + responseContent);
     ...
     * @throws Exception
     */
    public static String sendPostByJson2(String url, String body) throws Exception {
        CloseableHttpClient httpclient = HttpClients.custom().build();
        HttpPost post = null;
        String resData = null;
        CloseableHttpResponse result = null;
        try {
            ...
            FileUtils.copyInputStreamToFile(inputStream, new File("/Users/yu/Desktop/6923450605226/temp/aaa.jpg"));
            //String base64="data:image/png;base64,"+new String(Base64Utils.encodeBase64(inputStream));
            return "/Users/yu/Desktop/6923450605226/temp/aaa.jpg";
        } finally {
            if (result != null) {
                result.close();
            }
